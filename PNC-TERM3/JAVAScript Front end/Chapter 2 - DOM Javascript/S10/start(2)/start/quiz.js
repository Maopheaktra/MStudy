...
function renderQuestion() {
  ...
  dom_question.textContent = current.title
  dom_choiceA.textContent = current.choiceA;
  dom_choiceB.textContent = current.choiceB;
  dom_choiceC.textContent = current.choiceC;
  dom_choiceD.textContent = current.choiceD
}
...
function renderSCore() {
  ...
  const scorePerCent = 100; // TODO to change
