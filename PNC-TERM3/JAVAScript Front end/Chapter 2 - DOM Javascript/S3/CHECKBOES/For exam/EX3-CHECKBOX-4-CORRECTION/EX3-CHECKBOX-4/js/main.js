function totalPrice(){
    ...
    for (const product of products) {
        ...
        // console.log(product.firstElementChild.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.value);
        // console.log(product.firstElementChild.nextElementSibling.nextElementSibling.textContent.split('$')[1]);
