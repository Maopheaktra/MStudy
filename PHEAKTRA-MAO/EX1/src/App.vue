  ...
  <div class="container mt-4">
    <div class="row">
      <div class="col-md-4 mb-4">
        <div class="card my-3" v-for="teacher in teachers" :key="teacher">
          <img v-bind:src="teacher.image" class="card-img-top" alt="teacher Image" />
          <div class="card-body">
            <h5 class="card-title"></h5>
            <p class="card-text">ID: {{teacher.id}}</p>
            <p class="card-text">Subject: {{teacher.subject}}</p>
            <p class="card-text">Score: {{teacher.score}}</p>
            <p class="text-danger" v-if="teacher.score<=49">Fail</p>
